...
INSERT INTO `silicon misiones`.`usuario` (`id_usuario`, `nickname`, `password`, `email`, `telefono`, `rol_id_rol`) VALUES ('1', 'admin', '$2b$10$F8B0UjNlLkZZG/h3WgCkEO1jBToCnS/NJEtjHdylngHdj6GJjEV2y', 'admin@gmail.com', '1144950525', '1');
